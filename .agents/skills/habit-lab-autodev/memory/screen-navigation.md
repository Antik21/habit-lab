...
This is a compact discovery index, not proof of current reachability. Canonical executable navigation paths are reviewed skill-owned Maestro flows; linked admitted nodes have terminal-success, passing-gate evidence.

| Surface | Canonical source of truth | Admitted reusable navigation node |
| --- | --- | --- |
