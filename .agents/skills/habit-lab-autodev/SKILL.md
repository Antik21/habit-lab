...
- Treat the repository Maestro runner as the current UI verification baseline, not as a generic AutoDev adapter. Do not manufacture missing device adapters, reservation pools, or self-patching mechanisms. The reviewed [checklist gate](references/checklist-gate.md) evaluates evidence without changing Maestro's runner/configuration contract. Reviewed, skill-owned Maestro subflows remain limited to composition through the runner-owned common scenario.
