...
- После изменения экрана выбрать Android/iOS проверки по
  [общей политике тестирования](../docs/07-testing-verification.md) и проверить ключевой
  пользовательский сценарий на обеих OS.
