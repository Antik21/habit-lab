...
private fun Content(
    ...
    HabitLabAppScaffold(
        automationId = NavigationSpikeAutomationIds.flowStepTwoScreenRoot,
        toolbar = {
            HabitLabToolbar(
                title = stringResource(Res.string.navigation_flow_step_two_title, state.flowId),
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.navigation_flow_step_two_subtitle),
                style = MaterialTheme.typography.bodyLarge,
            )
            HabitLabPrimaryButton(
                modifier = Modifier.fillMaxWidth(),
                label = stringResource(Res.string.navigation_flow_finish_label),
                automationId = NavigationSpikeAutomationIds.flowStepTwoFinish,
                onClick = { onAction(Action.FinishClicked) },
            )
        }
    }
}
